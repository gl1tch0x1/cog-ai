...
│       ├── core/               # Orchestrator, gateways, trace, memory
│       ├── engine/             # Auto-healer, telemetry, tool registry
...
│       ├── modules/            # Bypasses, correlations, external tools
...
│   ├── cli/                    # Go CLI wrapper
│   ├── recon/                  # Subdomain, probe, crawl, params
│   └── scanners/               # Port and service scanning
│
...
│
├── SKILL.md                    # Advanced hunting strategies
